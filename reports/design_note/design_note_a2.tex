...
articles older than 30 days (Fig.~\ref{fig:fresh}); ``newer ranks higher'' scores 0.501 AUC,
...
\caption{Click rate of EB-NeRD test candidates by article age (2,928,942 candidates).}\label{fig:fresh}\end{figure}
...
\bottomrule\end{tabular}}\end{table}
\begin{table}[H]\centering\scriptsize
\caption{Single-stage A1 scorers on the shown lists (A1 harness; MIND 73,152 and EB-NeRD small 20,000 test impressions).}\label{tab:a1}
\fitwidth{\begin{tabular}{llrrrrrr}\toprule
 & scorer & AUC [95\% CI] & diversity & novelty & coverage & AUC cold / warm & AUC head / tail \\\midrule
MIND & popularity & 0.495 [0.494, 0.496] & 0.932 & 16.05 & 0.046 & 0.498 / 0.494 & 0.765 / 0.487 \\
 & semantic & 0.642 [0.640, 0.644] & 0.893 & 16.93 & 0.053 & 0.605 / 0.651 & 0.623 / 0.643 \\
EB-NeRD small & popularity & 0.446 [0.444, 0.447] & 0.183 & 16.85 & 0.130 & 0.444 / 0.446 & 0.961 / 0.442 \\
 & semantic & 0.528 [0.524, 0.533] & 0.173 & 17.02 & 0.128 & 0.521 / 0.529 & 0.682 / 0.527 \\
\bottomrule\end{tabular}}\end{table}
...
MIND 13967 & NRMS & 2,370,727 & 107.3 & 0.6232 & \multicolumn{4}{c}{\textit{pending}}\\
EB-NeRD 2469 & NRMS + freshness & 13,536,710 & 221.4 & 0.6459 & \multicolumn{4}{c}{\textit{pending}}\\
\bottomrule\end{tabular}}\end{table}
\begin{figure}[H]\centering
\begin{minipage}{0.48\linewidth}\centering \fbox{\parbox[c][3.2cm][c]{0.92\linewidth}{\centering\small\textit{Screenshot pending:} MIND submission result\\\footnotesize add \texttt{screenshots/mind\_submission.png} and rebuild}}\end{minipage}\hfill
\begin{minipage}{0.48\linewidth}\centering \fbox{\parbox[c][3.2cm][c]{0.92\linewidth}{\centering\small\textit{Screenshot pending:} MIND leaderboard\\\footnotesize add \texttt{screenshots/mind\_leaderboard.png} and rebuild}}\end{minipage}\\[4pt]
\begin{minipage}{0.48\linewidth}\centering \fbox{\parbox[c][3.2cm][c]{0.92\linewidth}{\centering\small\textit{Screenshot pending:} EB-NeRD submission result\\\footnotesize add \texttt{screenshots/ebnerd\_submission.png} and rebuild}}\end{minipage}\hfill
\begin{minipage}{0.48\linewidth}\centering \fbox{\parbox[c][3.2cm][c]{0.92\linewidth}{\centering\small\textit{Screenshot pending:} EB-NeRD leaderboard\\\footnotesize add \texttt{screenshots/ebnerd\_leaderboard.png} and rebuild}}\end{minipage}
...
\textbf{Features unavailable at serving time} (Q9). EB-NeRD ships lifetime totals (\texttt{total\_inviews}, \texttt{total\_pageviews}, \texttt{total\_read\_time}) that are only known
