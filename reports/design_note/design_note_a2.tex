...
\begin{minipage}{0.48\linewidth}\centering \fbox{\parbox[c][2.7cm][c]{0.92\linewidth}{\centering\small\textit{Screenshot pending:} MIND submission result\\\footnotesize add \texttt{screenshots/mind\_submission.png} and rebuild}}\end{minipage}\hfill
\begin{minipage}{0.48\linewidth}\centering \fbox{\parbox[c][2.7cm][c]{0.92\linewidth}{\centering\small\textit{Screenshot pending:} MIND leaderboard\\\footnotesize add \texttt{screenshots/mind\_leaderboard.png} and rebuild}}\end{minipage}\\[4pt]
\begin{minipage}{0.48\linewidth}\centering \fbox{\parbox[c][2.7cm][c]{0.92\linewidth}{\centering\small\textit{Screenshot pending:} EB-NeRD submission result\\\footnotesize add \texttt{screenshots/ebnerd\_submission.png} and rebuild}}\end{minipage}\hfill
\begin{minipage}{0.48\linewidth}\centering \fbox{\parbox[c][2.7cm][c]{0.92\linewidth}{\centering\small\textit{Screenshot pending:} EB-NeRD leaderboard\\\footnotesize add \texttt{screenshots/ebnerd\_leaderboard.png} and rebuild}}\end{minipage}
